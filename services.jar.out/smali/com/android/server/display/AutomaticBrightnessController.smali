...
.field private static BRIGHTENING_HYSTERESIS_HIGHLUX:F = 0.0f

.field private static BRIGHTENING_HYSTERESIS_LOWLUX:F = 0.0f
...
.field private static DARKENING_HYSTERESIS_HIGHLUX:F = 0.0f

.field private static DARKENING_HYSTERESIS_LOWLUX:F = 0.0f
...
.field private static HIGHLUX_THRESHOLD:I = 0x0
...
.field private static ULTRAHIGHLUX_THRESHOLD:I = 0x0
...
.field private isHighLux:Z

.field private isLowLux:Z

.field private isUltraHighLux:Z
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/server/display/AutomaticBrightnessController;->HIGHLUX_THRESHOLD:I

    const/16 v0, 0x320

    sput v0, Lcom/android/server/display/AutomaticBrightnessController;->ULTRAHIGHLUX_THRESHOLD:I
...
.method public constructor <init>(Lcom/android/server/display/AutomaticBrightnessController$Callbacks;Landroid/os/Looper;Landroid/hardware/SensorManager;Landroid/util/Spline;IIIFIJJZLandroid/content/Context;)V
    .locals 6
    ...
    iput-boolean v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->isLowLux:Z

    const/4 v3, 0x0

    iput-boolean v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->isHighLux:Z

    const/4 v3, 0x0

    iput-boolean v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->isUltraHighLux:Z

    const/4 v3, 0x1

    iput-boolean v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mUseProximityConfig:Z

    const/4 v3, 0x0

    iput-boolean v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mUseAccConfig:Z

    const/4 v3, 0x0

    iput v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->angle_xy2horizon:F

    const/4 v3, -0x1

    iput v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mProximity:I
    ...
    iput-object v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAccSensorListener:Landroid/hardware/SensorEventListener;
    ...
    const-string v5, "mUseProximityConfig : "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p0, Lcom/android/server/display/AutomaticBrightnessController;->mUseProximityConfig:Z
    ...
    iget-boolean v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mUseProximityConfig:Z
    ...
    iget-object v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mProximitySensor:Landroid/hardware/Sensor;
    ...
    iput v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mProximityThreshold:F
    ...
    sput v3, Lcom/android/server/display/AutomaticBrightnessController;->DARKENING_HYSTERESIS_ZERO2FOV:F
    ...
    sput v3, Lcom/android/server/display/AutomaticBrightnessController;->DARKENING_HYSTERESIS_FOV2SEVENTY:F
    ...
    sput v3, Lcom/android/server/display/AutomaticBrightnessController;->DARKENING_HYSTERESIS_SEVENTY2NINETY:F
    ...
    sput v3, Lcom/android/server/display/AutomaticBrightnessController;->DARKENING_HYSTERESIS_LOWLUX:F
    ...
    sput v3, Lcom/android/server/display/AutomaticBrightnessController;->DARKENING_HYSTERESIS_HIGHLUX:F
    ...
    sput v3, Lcom/android/server/display/AutomaticBrightnessController;->BRIGHTENING_HYSTERESIS_LOWLUX:F
    ...
    sput v3, Lcom/android/server/display/AutomaticBrightnessController;->BRIGHTENING_HYSTERESIS_HIGHLUX:F
    ...
    sput v3, Lcom/android/server/display/AutomaticBrightnessController;->ALS_FOV:I
    ...
    sput v3, Lcom/android/server/display/AutomaticBrightnessController;->HIGHANGLE_THRESHOLD:F
    ...
    sput v3, Lcom/android/server/display/AutomaticBrightnessController;->HIGHLUX_THRESHOLD:I
    ...
    sput v3, Lcom/android/server/display/AutomaticBrightnessController;->ULTRAHIGHLUX_THRESHOLD:I
    ...
    const-string v5, "DARKENING_HYSTERESIS_ZERO2FOV = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/display/AutomaticBrightnessController;->DARKENING_HYSTERESIS_ZERO2FOV:F
    ...
    const-string v5, "DARKENING_HYSTERESIS_FOV2SEVENTY = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/display/AutomaticBrightnessController;->DARKENING_HYSTERESIS_FOV2SEVENTY:F
    ...
    const-string v5, "DARKENING_HYSTERESIS_SEVENTY2NINETY = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/display/AutomaticBrightnessController;->DARKENING_HYSTERESIS_SEVENTY2NINETY:F
    ...
    const-string v5, "DARKENING_HYSTERESIS_LOWLUX = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/display/AutomaticBrightnessController;->DARKENING_HYSTERESIS_LOWLUX:F
    ...
    const-string v5, "DARKENING_HYSTERESIS_HIGHLUX = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/display/AutomaticBrightnessController;->DARKENING_HYSTERESIS_HIGHLUX:F
    ...
    const-string v5, "BRIGHTENING_HYSTERESIS_LOWLUX = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/display/AutomaticBrightnessController;->BRIGHTENING_HYSTERESIS_LOWLUX:F
    ...
    const-string v5, "BRIGHTENING_HYSTERESIS_HIGHLUX = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/display/AutomaticBrightnessController;->BRIGHTENING_HYSTERESIS_HIGHLUX:F
    ...
    const-string v5, "ALS_FOV = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/display/AutomaticBrightnessController;->ALS_FOV:I
    ...
    const-string v5, "HIGHANGLE_THRESHOLD = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/display/AutomaticBrightnessController;->HIGHANGLE_THRESHOLD:F
    ...
    const-string v5, "HIGHLUX_THRESHOLD = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/display/AutomaticBrightnessController;->HIGHLUX_THRESHOLD:I
    ...
    const-string v5, "ULTRAHIGHLUX_THRESHOLD = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/display/AutomaticBrightnessController;->ULTRAHIGHLUX_THRESHOLD:I
    ...
    const-string v5, "mUseAccConfig = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p0, Lcom/android/server/display/AutomaticBrightnessController;->mUseAccConfig:Z
    ...
    iget-boolean v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mUseAccConfig:Z
    ...
    iput-object v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAccelerometer:Landroid/hardware/Sensor;
...
.method static synthetic access$1200(Lcom/android/server/display/AutomaticBrightnessController;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/AutomaticBrightnessController;
    .param p1, "x1"    # Z
...
.method static synthetic access$400(Lcom/android/server/display/AutomaticBrightnessController;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/AutomaticBrightnessController;
...
.method static synthetic access$900(Lcom/android/server/display/AutomaticBrightnessController;)F
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/AutomaticBrightnessController;
...
.method private handleLightSensorEvent(JF)V
    ...
    sget v0, Lcom/android/server/display/AutomaticBrightnessController;->ULTRAHIGHLUX_THRESHOLD:I
    ...
    iput-boolean v1, p0, Lcom/android/server/display/AutomaticBrightnessController;->isLowLux:Z

    iput-boolean v1, p0, Lcom/android/server/display/AutomaticBrightnessController;->isHighLux:Z

    iput-boolean v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->isUltraHighLux:Z
    ...
    :cond_0
    sget v0, Lcom/android/server/display/AutomaticBrightnessController;->HIGHLUX_THRESHOLD:I
    ...
    iput-boolean v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->isHighLux:Z

    iput-boolean v1, p0, Lcom/android/server/display/AutomaticBrightnessController;->isUltraHighLux:Z

    goto :goto_0

    :cond_1
    iput-boolean v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->isLowLux:Z
...
.method private setAccSensorEnabled(Z)Z
    ...
    iget-boolean v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAccSensorEnabled:Z

    if-nez v2, :cond_1

    iput-boolean v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAccSensorEnabled:Z
    ...
    iget-object v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAccSensorListener:Landroid/hardware/SensorEventListener;

    iget-object v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAccelerometer:Landroid/hardware/Sensor;
    ...
    iput-boolean v1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAccSensorEnabled:Z
...
.method private setAmbientLux(F)V
    ...
    iget-boolean v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->isUltraHighLux:Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->isHighLux:Z

    if-ne v0, v3, :cond_3

    iget v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAmbientLux:F

    sget v1, Lcom/android/server/display/AutomaticBrightnessController;->BRIGHTENING_HYSTERESIS_HIGHLUX:F
    ...
    sget v1, Lcom/android/server/display/AutomaticBrightnessController;->DARKENING_HYSTERESIS_HIGHLUX:F
    ...
    :cond_1
    :goto_1
    iget v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->angle_xy2horizon:F
    ...
    const-string v2, "setAmbientLux: mAmbientLux="
    ...
    const-string v2, ", mBrighteningLuxThreshold="
    ...
    const-string v2, ", mDarkeningLuxThreshold="
    ...
    const-string v2, ", angle_xy2horizon="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->angle_xy2horizon:F
    ...
    :cond_3
    iget-boolean v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->isLowLux:Z

    if-ne v0, v3, :cond_1

    iget v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAmbientLux:F

    sget v1, Lcom/android/server/display/AutomaticBrightnessController;->BRIGHTENING_HYSTERESIS_LOWLUX:F
    ...
    sget v1, Lcom/android/server/display/AutomaticBrightnessController;->DARKENING_HYSTERESIS_LOWLUX:F
...
.method private setLightSensorEnabled(Z)Z
    ...
    const-string v3, "setLightSensorEnabled disable"
...
.method private setProximitySensorEnabled(Z)V
    ...
    const-string v1, "setProximitySensorEnabled enable"
    ...
    const-string v1, "setProximitySensorEnabled disable"
...
.method private updateAmbientLux(J)V
    ...
    iput-boolean v1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mFirstFastChangeBrightness:Z
