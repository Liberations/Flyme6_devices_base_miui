...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    .local v0, "maxBg":I
    :try_start_0
    const-string v3, "ro.config.max_starting_bg"
...
.method public onBootCompleted()V
    ...
    const-string v1, "reset additional starting bg to 0"
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IILjava/lang/String;I)Landroid/content/ComponentName;
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/miui/whetstone/client/WhetstoneClientManager;->isStartServiceAllowedLocked(Landroid/content/Intent;ILjava/lang/String;I)Z
    ...
    const-string v6, "MiuiLog-Whetstone-ServiceControl not allowed to start service in a frozen app!"
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/server/am/ServiceRecord;->makeNextStartId()I
    ...
    .local v14, "smap":Lcom/android/server/am/ActiveServices$ServiceMap;
    const/16 v18, 0x0

    .local v18, "addToStarting":Z
    if-nez v12, :cond_c
    ...
    :cond_a
    iget-object v4, v14, Lcom/android/server/am/ActiveServices$ServiceMap;->mStartingBackground:Ljava/util/ArrayList;
    ...
    iget-object v4, v14, Lcom/android/server/am/ActiveServices$ServiceMap;->mDelayedStartList:Ljava/util/ArrayList;
    ...
    .local v22, "retName":Landroid/content/ComponentName;
    const/16 v5, 0x7576
    ...
    invoke-virtual {v0, v8, v10, v11, v13}, Landroid/content/Intent;->toShortString(ZZZZ)Ljava/lang/String;
    ...
    .end local v22    # "retName":Landroid/content/ComponentName;
    ...
    .end local v20    # "proc":Lcom/android/server/am/ProcessRecord;
    .restart local v22    # "retName":Landroid/content/ComponentName;
    :cond_e
    const/4 v4, -0x1
