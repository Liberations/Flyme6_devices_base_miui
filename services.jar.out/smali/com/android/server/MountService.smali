...
.field private mDelayMountedPubVolumes:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/MountService;->mDelayMountedPubVolumes:Ljava/util/ArrayList;
...
.method private onStartUser(I)V
    ...
    :goto_0
    iget-object v7, p0, Lcom/android/server/MountService;->mLock:Ljava/lang/Object;
    ...
    invoke-virtual {v5, p1}, Landroid/os/storage/VolumeInfo;->isVisibleForRead(I)Z
    ...
    invoke-virtual {v5, v6, p1, v8}, Landroid/os/storage/VolumeInfo;->buildStorageVolume(Landroid/content/Context;IZ)Landroid/os/storage/StorageVolume;
    ...
    invoke-static {v6, v8, v0, v0}, Lcom/android/server/MountService$Callbacks;->access$1500(Lcom/android/server/MountService$Callbacks;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v6, p0, Lcom/android/server/MountService;->mStartedUsers:[I

    invoke-static {v6, p1}, Lcom/android/internal/util/ArrayUtils;->appendInt([II)[I

    move-result-object v6

    iput-object v6, p0, Lcom/android/server/MountService;->mStartedUsers:[I

    iget-object v6, p0, Lcom/android/server/MountService;->mDelayMountedPubVolumes:Ljava/util/ArrayList;
    ...
    .local v3, "pubVolume":Landroid/os/storage/VolumeInfo;
    const-string v6, "MountService"
    ...
    const-string v9, "user have started, start mounting delay public volume: "
    ...
    .end local v2    # "i$":Ljava/util/Iterator;
    .end local v3    # "pubVolume":Landroid/os/storage/VolumeInfo;
    :catchall_0
    move-exception v6
...
.method private onVolumeCreatedLocked(Landroid/os/storage/VolumeInfo;)V
    ...
    const-string v4, "mStartedUsers is empty, delay mount public volume: "
    ...
    iget-object v2, p0, Lcom/android/server/MountService;->mDelayMountedPubVolumes:Ljava/util/ArrayList;
    ...
    const-string v4, "mStartedUsers exist, then mount public volume: "
