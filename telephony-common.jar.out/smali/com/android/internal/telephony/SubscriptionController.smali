...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, Lcom/android/internal/telephony/SubscriptionController;->initForCancro()V
...
.method static synthetic access$000(Lcom/android/internal/telephony/SubscriptionController;Landroid/content/Intent;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/SubscriptionController;
    .param p1, "x1"    # Landroid/content/Intent;

    .prologue
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/SubscriptionController;->resetDdsForCancroIfNeeded(Landroid/content/Intent;)V

    return-void
.end method

.method static synthetic access$100(Lcom/android/internal/telephony/SubscriptionController;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/SubscriptionController;

    .prologue
    iget-boolean v0, p0, Lcom/android/internal/telephony/SubscriptionController;->mIsVirtualSimEnabled:Z
...
.method static synthetic access$102(Lcom/android/internal/telephony/SubscriptionController;Z)Z
    ...
    .prologue
    iput-boolean p1, p0, Lcom/android/internal/telephony/SubscriptionController;->mIsVirtualSimEnabled:Z
...
.method private initForCancro()V
    .locals 5
    ...
    iput-boolean v2, p0, Lcom/android/internal/telephony/SubscriptionController;->mIsVirtualSimEnabled:Z

    new-instance v1, Lcom/android/internal/telephony/SubscriptionController$3;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/android/internal/telephony/SubscriptionController$3;-><init>(Lcom/android/internal/telephony/SubscriptionController;Landroid/os/Handler;)V

    .local v1, "virtualSimObserver":Landroid/database/ContentObserver;
    iget-object v2, p0, Lcom/android/internal/telephony/SubscriptionController;->mContext:Landroid/content/Context;
    ...
    invoke-static {v3}, Lmiui/provider/ExtraSettings$System;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;
...
.method private resetDdsForCancroIfNeeded(Landroid/content/Intent;)V
    .locals 8
    ...
    :cond_1
    sget-object v4, Lcom/android/internal/telephony/SubscriptionController;->sProxyPhones:[Lcom/android/internal/telephony/PhoneProxy;

    array-length v4, v4

    if-le v4, v3, :cond_0

    iget-boolean v4, p0, Lcom/android/internal/telephony/SubscriptionController;->mIsVirtualSimEnabled:Z
    ...
    invoke-static {v4}, Landroid/provider/MiuiSettings$VirtualSim;->getVirtualSimSlotId(Landroid/content/Context;)I

    move-result v1

    .local v1, "virtualSlot":I
    iget-object v4, p0, Lcom/android/internal/telephony/SubscriptionController;->mContext:Landroid/content/Context;
    ...
    :cond_2
    invoke-static {v4, v5, v2, v3}, Landroid/telephony/TelephonyManager;->putIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    invoke-static {v2, v3, v1, v4}, Landroid/telephony/TelephonyManager;->putIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;II)Z

    goto :goto_0

    .end local v1    # "virtualSlot":I
    :cond_3
    if-eqz p1, :cond_4
    ...
    const-string v3, "resetDdsForCancroIfNeeded return for has card in slot="
    ...
    invoke-virtual {v4, v2}, Lmiui/telephony/SubscriptionManager;->setDefaultDataSlotId(I)V

    invoke-virtual {p0}, Lcom/android/internal/telephony/SubscriptionController;->resetDdsForCancro()V

    const-string v4, "resetDdsForCancroIfNeeded setPreferredNetworkType"
    ...
    invoke-static {v4, v5, v3, v3}, Landroid/telephony/TelephonyManager;->putIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    invoke-static {v4, v5, v2, v6}, Landroid/telephony/TelephonyManager;->putIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;II)Z

    sget-object v4, Lcom/android/internal/telephony/SubscriptionController;->sProxyPhones:[Lcom/android/internal/telephony/PhoneProxy;

    aget-object v4, v4, v3

    invoke-virtual {v4, v3, v7}, Lcom/android/internal/telephony/PhoneProxy;->setPreferredNetworkType(ILandroid/os/Message;)V

    sget-object v3, Lcom/android/internal/telephony/SubscriptionController;->sProxyPhones:[Lcom/android/internal/telephony/PhoneProxy;

    aget-object v2, v3, v2

    sget v3, Lcom/android/internal/telephony/RILConstants;->PREFERRED_NETWORK_MODE:I

    invoke-virtual {v2, v3, v7}, Lcom/android/internal/telephony/PhoneProxy;->setPreferredNetworkType(ILandroid/os/Message;)V
...
.method public resetDdsForCancro()V
    .locals 1

    .prologue
    const-string v0, "resetDdsForCancro should not be called"
