...
.method private onSetStreamVolume(IIIILjava/lang/String;)V
    ...
    invoke-static {v0, v6}, Lmiui/util/AudioManagerHelper;->getValidatedRingerMode(Landroid/content/Context;I)I
...
.method private sendDeviceConnectionIntent(IILjava/lang/String;Ljava/lang/String;)V
    ...
    iget v15, v2, Landroid/media/AudioRoutesInfo;->mainType:I
    ...
    iput v15, v2, Landroid/media/AudioRoutesInfo;->mainType:I
    ...
    :try_start_1
    invoke-static {v14, v2, v3}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    invoke-direct {v0, v14, v1}, Lcom/android/server/audio/AudioService;->configureHdmiPlugIntent(Landroid/content/Intent;I)V
...
.method setBtScoDeviceConnectionState(Landroid/bluetooth/BluetoothDevice;I)V
    ...
    const-string v8, "SCO is there with another device, returning"
