...
.method constructor <init>(Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;Lcom/android/server/am/RecentTasks;)V
    ...
    iput-object v1, p0, Lcom/android/server/am/ActivityStack;->mResumePerf:Landroid/util/BoostFramework;

    iput v2, p0, Lcom/android/server/am/ActivityStack;->rBoostTimeOut:I
...
.method private resumeTopActivityInnerLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    iget-boolean v3, v3, Lcom/android/server/am/ActivityStackSupervisor;->mIsPerfBoostEnabled:Z

    if-eqz v3, :cond_15

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/am/ActivityStack;->mResumePerf:Landroid/util/BoostFramework;
    ...
    iput-object v3, v0, Lcom/android/server/am/ActivityStack;->mResumePerf:Landroid/util/BoostFramework;
    ...
    iput v3, v0, Lcom/android/server/am/ActivityStack;->rBoostTimeOut:I
    ...
    iget v4, v0, Lcom/android/server/am/ActivityStack;->rBoostTimeOut:I

    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/server/am/ActivityStack;->mStackSupervisor:Lcom/android/server/am/ActivityStackSupervisor;

    iget-object v5, v5, Lcom/android/server/am/ActivityStackSupervisor;->lBoostCpuParamVal:[I
...
.method final moveTaskToBackLocked(I)Z
    ...
    invoke-virtual {v13, v14}, Lcom/android/server/am/TaskRecord;->topRunningActivityLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;

    move-result-object v12

    .local v12, "topActivity":Lcom/android/server/am/ActivityRecord;
    if-eqz v12, :cond_5

    iget-boolean v14, v12, Lcom/android/server/am/ActivityRecord;->stopped:Z
    ...
    invoke-direct {v0, v12, v14}, Lcom/android/server/am/ActivityStack;->adjustFocusedActivityLocked(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;)V
    ...
    .end local v9    # "task":Lcom/android/server/am/TaskRecord;
    .end local v10    # "taskNdx":I
    .end local v12    # "topActivity":Lcom/android/server/am/ActivityRecord;
    :cond_8
    const/4 v2, 0x0
    ...
    .end local v9    # "task":Lcom/android/server/am/TaskRecord;
    .restart local v12    # "topActivity":Lcom/android/server/am/ActivityRecord;
    :cond_c
    const/4 v9, 0x0
