...
.field protected static final EVENT_NEED_SET_NETWORK_SELECTION_TYPE:I = 0x32

.field protected static final EVENT_NEED_SET_PREFERRED_NETWORK_TYPE:I = 0x31
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/CommandsInterface;Landroid/telephony/CellInfo;)V
    ...
    invoke-static {p0}, Lcom/android/internal/telephony/ServiceStateTrackerInjector;->init(Lcom/android/internal/telephony/ServiceStateTracker;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :cond_3
    iget-boolean v4, p0, Lcom/android/internal/telephony/ServiceStateTracker;->mImsRegistered:Z

    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/ServiceStateTracker;->updateIMSRegistedBroadcast(Z)V
...
.method protected updateIMSRegistedBroadcast()V
    .locals 3
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/PhoneBase;->getImsPhone()Lcom/android/internal/telephony/Phone;
    ...
    .local v0, "callTracker":Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;
    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->updateIMSRegistedBroadcast()V

    .end local v0    # "callTracker":Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;
    :cond_1
    :goto_0
    return-void
    ...
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/ServiceStateTracker;->updateIMSRegistedBroadcast(Z)V

    goto :goto_0
.end method

.method protected updateIMSRegistedBroadcast(Z)V
    .locals 2
    ...
    invoke-virtual {v0, p1, v1}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->sendIMSRegistedStateBroadcast(ZI)V
