...
.method public constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    iput v5, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mCurState:I
...
.method private isOperatorConsideredNonRoaming(Landroid/telephony/ServiceState;)Z
    ...
    invoke-static {p0, v5}, Lcom/android/internal/telephony/ServiceStateTrackerInjector;->isOperatorConsideredNonRoaming(Lcom/android/internal/telephony/ServiceStateTracker;Ljava/lang/String;)Z
    ...
    invoke-static {v9, v10}, Landroid/telephony/SubscriptionManager;->getResourcesForSubId(Landroid/content/Context;I)Landroid/content/res/Resources;
...
.method private isOperatorConsideredRoaming(Landroid/telephony/ServiceState;)Z
    ...
    invoke-static {v8, v9}, Landroid/telephony/SubscriptionManager;->getResourcesForSubId(Landroid/content/Context;I)Landroid/content/res/Resources;
...
.method private pollStateDone()V
    ...
    :cond_6
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->updateIMSRegistedBroadcast()V
...
.method private revertToNitzTimeZone()V
    ...
    invoke-static {v1}, Lcom/android/internal/telephony/ServiceStateTrackerInjector;->getReceivedNitz(I)Z
    ...
    const-string v1, "revertToNitzTimeZone do nothing for other phone received NITZ"
    ...
    invoke-static {v1, v2}, Lcom/android/internal/telephony/ServiceStateTrackerInjector;->getRevertTimeZoneId(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v0

    .local v0, "newZoneId":Ljava/lang/String;
    if-eqz v0, :cond_3

    invoke-direct {p0, v0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->saveNitzTimeZone(Ljava/lang/String;)V

    .end local v0    # "newZoneId":Ljava/lang/String;
    :cond_3
    new-instance v1, Ljava/lang/StringBuilder;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-interface/range {v25 .. v26}, Lcom/android/internal/telephony/CommandsInterface;->getPreferredNetworkType(Landroid/os/Message;)V
    ...
    :sswitch_14
    const-string v25, "EVENT_NEED_SET_PREFERRED_NETWORK_TYPE"
    ...
    .local v17, "preferredNetworkModeInModem":I
    iget-object v0, v4, Landroid/os/AsyncResult;->exception:Ljava/lang/Throwable;
    ...
    .local v16, "preferredNetworkModeInAP":I
    :try_start_3
    move-object/from16 v0, p0
    ...
    invoke-static/range {v25 .. v27}, Landroid/telephony/TelephonyManager;->getIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    :try_end_3
    ...
    const-string v27, "preferred network in modem is "
    ...
    const-string v27, " preferred network in AP is "
    ...
    const-string v26, "preferrred network mode doesn\'t match. Restore"
    ...
    invoke-interface/range {v25 .. v26}, Lcom/android/internal/telephony/CommandsInterface;->getNetworkSelectionMode(Landroid/os/Message;)V
    ...
    const-string v26, "getPreferredNetworkMode: Could not find PREFERRED_NETWORK_MODE!!!"
    ...
    .end local v4    # "ar":Landroid/os/AsyncResult;
    .end local v16    # "preferredNetworkModeInAP":I
    .end local v17    # "preferredNetworkModeInModem":I
    .end local v21    # "snfe":Landroid/provider/Settings$SettingNotFoundException;
    :sswitch_15
    const-string v25, "EVENT_NEED_SET_NETWORK_SELECTION_TYPE"
    ...
    .local v12, "networkSelectionModeInModem":I
    iget-object v0, v4, Landroid/os/AsyncResult;->exception:Ljava/lang/Throwable;
    ...
    const-string v25, "network_selection_key"
    ...
    .local v11, "networkSelectionModeInAP":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v27, "network selection mode in modem is "
    ...
    const-string v27, " network selection mode in AP is "
    ...
    .local v19, "selectionModeIsManual_AP":Z
    :goto_6
    if-nez v12, :cond_e

    const/16 v18, 0x0

    .local v18, "selecitonModeIsManual_Modem":Z
    :goto_7
    if-nez v20, :cond_c
    ...
    const-string v26, "network selection mode doesn\'t match. Restore"
    ...
    invoke-virtual/range {v25 .. v26}, Lcom/android/internal/telephony/gsm/GSMPhone;->restoreSavedNetworkSelection(Landroid/os/Message;)V
    ...
    .end local v18    # "selecitonModeIsManual_Modem":Z
    .end local v19    # "selectionModeIsManual_AP":Z
    :cond_d
    const/16 v19, 0x1

    goto :goto_6

    .restart local v19    # "selectionModeIsManual_AP":Z
    :cond_e
    const/16 v18, 0x1
...
.method protected handlePollStateResult(ILandroid/os/AsyncResult;)V
    ...
    invoke-static {v0, v11, v3, v15, v1}, Lmiui/telephony/RegInfoMonitor;->notifyRegInfoUpdate(Lcom/android/internal/telephony/gsm/GSMPhone;III[Ljava/lang/String;)V
    ...
    invoke-static {v0, v1}, Lcom/android/internal/telephony/ServiceStateTrackerInjector;->convertNetworkType(Lcom/android/internal/telephony/ServiceStateTracker;I)I
...
.method protected updateSpnDisplay()V
    ...
    iget v2, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mCurState:I
    ...
    iput v1, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mCurState:I
