...
.method public static installPackage(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/String;)V
    .locals 10
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "packageFile"    # Ljava/io/File;
    .param p2, "secret"    # Ljava/lang/String;
    .param p3, "isErase"    # Ljava/lang/Boolean;
    .param p4, "userpw"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
    ...
    .local v6, "validateArg":Ljava/lang/String;
    :goto_0
    new-instance v7, Ljava/lang/StringBuilder;
    ...
    const-string v0, "--update_wipe"

    .local v0, "eraseArg":Ljava/lang/String;
    :goto_1
    ...
    .local v5, "userpwArg":Ljava/lang/String;
    :goto_2
    const/4 v7, 0x5
    ...
    .end local v0    # "eraseArg":Ljava/lang/String;
    .end local v2    # "filenameArg":Ljava/lang/String;
    .end local v3    # "localeArg":Ljava/lang/String;
    .end local v5    # "userpwArg":Ljava/lang/String;
    .end local v6    # "validateArg":Ljava/lang/String;
    :catchall_0
    move-exception v7
    ...
    .restart local v6    # "validateArg":Ljava/lang/String;
    :cond_3
    const-string v0, ""

    goto :goto_1

    .restart local v0    # "eraseArg":Ljava/lang/String;
    :cond_4
    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "--secure_pw="
