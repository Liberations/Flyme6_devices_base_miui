...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;Ljava/util/concurrent/CountDownLatch;JLjava/io/File;JI)V
    ...
    iput-wide p3, p0, Lcom/android/server/pm/PackageManagerService$27;->val$startFreeBytes:J

    iput-object p5, p0, Lcom/android/server/pm/PackageManagerService$27;->val$measurePath:Ljava/io/File;

    iput-wide p6, p0, Lcom/android/server/pm/PackageManagerService$27;->val$sizeBytes:J

    iput p8, p0, Lcom/android/server/pm/PackageManagerService$27;->val$moveId:I
...
.method public run()V
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lcom/android/server/pm/PackageManagerService$27;->val$installedLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    :cond_0
    iget-wide v0, p0, Lcom/android/server/pm/PackageManagerService$27;->val$startFreeBytes:J

    iget-object v2, p0, Lcom/android/server/pm/PackageManagerService$27;->val$measurePath:Ljava/io/File;
    ...
    iget-wide v2, p0, Lcom/android/server/pm/PackageManagerService$27;->val$sizeBytes:J
    ...
    iget v1, p0, Lcom/android/server/pm/PackageManagerService$27;->val$moveId:I

    # invokes: Lcom/android/server/pm/PackageManagerService$MoveCallbacks;->notifyStatusChanged(II)V
    invoke-static {v0, v1, v8}, Lcom/android/server/pm/PackageManagerService$MoveCallbacks;->access$6100(Lcom/android/server/pm/PackageManagerService$MoveCallbacks;II)V
