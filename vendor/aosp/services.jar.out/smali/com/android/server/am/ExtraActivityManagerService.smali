...
.method static checkStartActivityPermission(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;Landroid/app/IApplicationThread;Landroid/content/pm/ActivityInfo;Landroid/content/Intent;Ljava/lang/String;ZIZIILjava/lang/String;)Landroid/content/Intent;
    ...
    .local v13, "callerAppInfo":Landroid/content/pm/ApplicationInfo;
    const/4 v11, 0x0

    .local v11, "calleeAlreadyStarted":Z
    const/4 v15, 0x0

    .local v15, "havePermission":Z
    monitor-enter p1
    ...
    .end local v13    # "callerAppInfo":Landroid/content/pm/ApplicationInfo;
    .end local v15    # "havePermission":Z
    ...
    .restart local v13    # "callerAppInfo":Landroid/content/pm/ApplicationInfo;
    .restart local v15    # "havePermission":Z
    ...
    invoke-virtual/range {v3 .. v12}, Lmiui/security/SecurityManager;->getCheckIntent(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;ZIZI)Landroid/content/Intent;

    move-result-object v14

    .local v14, "checkIntent":Landroid/content/Intent;
    if-eqz v14, :cond_3
    ...
    .end local v11    # "calleeAlreadyStarted":Z
    .end local v13    # "callerAppInfo":Landroid/content/pm/ApplicationInfo;
    .end local v14    # "checkIntent":Landroid/content/Intent;
    .end local v15    # "havePermission":Z
    :cond_3
    move-object/from16 v16, p4
