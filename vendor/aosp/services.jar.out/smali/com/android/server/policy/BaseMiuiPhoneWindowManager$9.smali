...
.method constructor <init>(Lcom/android/server/policy/BaseMiuiPhoneWindowManager;Ljava/lang/CharSequence;)V
    ...
    iput-object p2, p0, Lcom/android/server/policy/BaseMiuiPhoneWindowManager$9;->val$msg:Ljava/lang/CharSequence;
...
.method public run()V
    ...
    iget-object v0, v0, Lcom/android/server/policy/BaseMiuiPhoneWindowManager$9;->this$0:Lcom/android/server/policy/BaseMiuiPhoneWindowManager;

    move-object/from16 v16, v0

    # getter for: Lcom/android/server/policy/BaseMiuiPhoneWindowManager;->mMiuiBootMsgDialog:Landroid/app/Dialog;
    invoke-static/range {v16 .. v16}, Lcom/android/server/policy/BaseMiuiPhoneWindowManager;->access$2800(Lcom/android/server/policy/BaseMiuiPhoneWindowManager;)Landroid/app/Dialog;
    ...
    new-instance v17, Lcom/android/server/policy/BaseMiuiPhoneWindowManager$9$1;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/server/policy/BaseMiuiPhoneWindowManager$9$1;-><init>(Lcom/android/server/policy/BaseMiuiPhoneWindowManager$9;Landroid/content/Context;I)V

    # setter for: Lcom/android/server/policy/BaseMiuiPhoneWindowManager;->mMiuiBootMsgDialog:Landroid/app/Dialog;
    invoke-static/range {v16 .. v17}, Lcom/android/server/policy/BaseMiuiPhoneWindowManager;->access$2802(Lcom/android/server/policy/BaseMiuiPhoneWindowManager;Landroid/app/Dialog;)Landroid/app/Dialog;
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/server/policy/BaseMiuiPhoneWindowManager;->access$2900(Lcom/android/server/policy/BaseMiuiPhoneWindowManager;)Landroid/widget/ProgressBar;
    ...
    invoke-static/range {v16 .. v17}, Lcom/android/server/policy/BaseMiuiPhoneWindowManager;->access$3002(Lcom/android/server/policy/BaseMiuiPhoneWindowManager;[Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/server/policy/BaseMiuiPhoneWindowManager;->access$3000(Lcom/android/server/policy/BaseMiuiPhoneWindowManager;)[Ljava/lang/String;
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/server/policy/BaseMiuiPhoneWindowManager;->access$3100(Lcom/android/server/policy/BaseMiuiPhoneWindowManager;)Landroid/widget/TextView;
    ...
    iget-object v0, v0, Lcom/android/server/policy/BaseMiuiPhoneWindowManager$9;->val$msg:Ljava/lang/CharSequence;
    ...
    # getter for: Lcom/android/server/policy/BaseMiuiPhoneWindowManager;->mBootText:[Ljava/lang/String;
    invoke-static/range {v17 .. v17}, Lcom/android/server/policy/BaseMiuiPhoneWindowManager;->access$3000(Lcom/android/server/policy/BaseMiuiPhoneWindowManager;)[Ljava/lang/String;
