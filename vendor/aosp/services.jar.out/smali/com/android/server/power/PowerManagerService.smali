...
.field public static final POWER_HINT_OTA:I = 0xa
...
.method static synthetic access$2700()Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 1
...
.method static synthetic access$2800(Lcom/android/server/power/PowerManagerService;ZZ)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # Z
    ...
    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/server/power/PowerManagerService;->broadcastWakeLockChanged(ZZ)V
...
.method static synthetic access$3900(Lcom/android/server/power/PowerManagerService;JLjava/lang/String;ILjava/lang/String;I)V
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # J
...
.method static synthetic access$4600(Lcom/android/server/power/PowerManagerService;)Z
    ...
    .prologue
    invoke-direct {p0}, Lcom/android/server/power/PowerManagerService;->isLightDeviceIdleModeInternal()Z
...
.method static synthetic access$5700(Lcom/android/server/power/PowerManagerService;Lcom/android/server/power/PowerManagerService$WakeLock;Z)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # Lcom/android/server/power/PowerManagerService$WakeLock;
    .param p2, "x2"    # Z
...
.method static synthetic access$5900(Lcom/android/server/power/PowerManagerService;)Landroid/os/RemoteCallbackList;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$6100(Lcom/android/server/power/PowerManagerService;II)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method static synthetic access$6200(Lcom/android/server/power/PowerManagerService;J)V
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # J
...
.method private broadcastPowerStateChanged(ZZ)V
    .locals 7
    .param p1, "screenOn"    # Z
    .param p2, "screenBright"    # Z
    ...
    const-string v4, "Only X4,X3 support this feature for low power consumption!"
    ...
    :cond_0
    iget-object v4, p0, Lcom/android/server/power/PowerManagerService;->mCallbacks:Landroid/os/RemoteCallbackList;

    monitor-enter v4

    :try_start_0
    iget-object v3, p0, Lcom/android/server/power/PowerManagerService;->mCallbacks:Landroid/os/RemoteCallbackList;
    ...
    check-cast v3, Landroid/os/IPowerManagerCallback;

    invoke-interface {v3, p1, p2}, Landroid/os/IPowerManagerCallback;->onPowerStateChanged(ZZ)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v6, "Unable to call onPowerStateChanged() on callback #"
...
.method private broadcastWakeLockChanged(ZZ)V
    .locals 7
    .param p1, "firstAcquire"    # Z
    .param p2, "lastRelease"    # Z
    ...
    invoke-interface {v3, p1, p2}, Landroid/os/IPowerManagerCallback;->onWakeLockChanged(ZZ)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v6, "Unable to call onWakeLockChanged() on callback #"
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    const-string v10, "  mLightDeviceIdleMode="

    invoke-virtual {v8, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-boolean v10, p0, Lcom/android/server/power/PowerManagerService;->mLightDeviceIdleMode:Z
...
.method private isLightDeviceIdleModeInternal()Z
    .locals 2
...
.method private wakeUpNoUpdateLocked(JLjava/lang/String;ILjava/lang/String;I)Z
    ...
    const-string v2, "waking up from opPackageName = "
